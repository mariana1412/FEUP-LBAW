<footer class="bottomNavbar d-lg-none">
    <div id="buttonGroup" class="btn-group selectors" role="group" aria-label="Mobile bottom navbar">
        ...
        <a id="home" class="btn button-active" href="/">
        ...
        @auth
            @if(Auth::user()->authenticated_user_type == "Moderator" || (Auth::user()->authenticated_user_type == "System Manager"))
                <a id="dashboard"  class="btn button-inactive" href="{{url('/moderator/reports')}}">
            ...
            @if(Auth::user()->authenticated_user_type == "System Manager")
                <a id="roles_manager"  class="btn button-inactive" href="{{url('/administration/roles')}}">
                    <div class="selector-holder">
            ...
            <a id="feed"  class="btn button-inactive" href="createpost.php">
                <div class="selector-holder">
                    <i class="bi bi-plus-square-dotted fs-1"></i>
                </div>
            </a>
            <a href="#" id="notifications"  class="btn button-inactive">

                <div class="selector-holder dropup">
                    <i role="button" data-bs-toggle="dropdown" aria-expanded="false" class="bi bi-bell fs-1"></i>
            ...
            <a id="account"  class="btn button-inactive" href="#">
                <div class="selector-holder dropup">
                    <i role="button" class="bi bi-person-circle fs-1" data-bs-toggle="dropdown" aria-expanded="false"></i>
                    <ul class="dropdown-menu">
        ...
        @endauth
        @guest
            <a id="login"  class="btn button-inactive">
